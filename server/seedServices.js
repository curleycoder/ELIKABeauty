...
const services = [
  { name: "Balayage", price: 200, fromPrice: true, duration: 240, category: "Hair", description: "Natural hand-painted highlights. *(Extra charge for base colour if needed.)" },
  ...
  { name: "Highlight", price: 180, duration: 210, fromPrice: true, category: "Hair", description: "Lighter strands to add dimension.  *(Extra charge for base colour if needed.)" },
  { name: "Root Colour", price: 65, duration: 90, category: "Hair", description: "Touch up your hair roots." },
  { name: "Hair Colour", price: 120, duration: 120, fromPrice: true, category: "Hair", description: "All-over colour for a new look." },
  ...
  { name: "Base Colour", price: 70, duration: 30, fromPrice: true, category: "Add-ons", description: "Add a base colour to enhance your highlight or balayage. Great for full coverage or colour correction."},
  ...
  { name: "Eyebrows treading", price: 17, duration: 20, category: "Face", description: "Define your brows naturally." },
  { name: "Eyebrows Tinting", price: 10, duration: 10, category: "Face", description: "Tint for bolder brows." },
  { name: "Full Treading", price: 40, duration: 30, category: "Face", description: "Remove facial hair by threading + Eyebrow Treading." },
  ...
  { name: "Men Hair Cut + Wash", price: 35, duration: 45, category: "Men", description: "Includes wash and haircut." }
];
