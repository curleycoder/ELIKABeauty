...
export default function ArticleCard({ article }) {
  ...
  return (
    <Link
      to={`/articles/${slug}`}
      className="block bg-white rounded-xl shadow-md overflow-hidden w-full max-w-md border border-pink-100 mx-auto hover:shadow-lg hover:-translate-y-1 transition-transform duration-200"
    >
