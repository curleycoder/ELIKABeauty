const services = [
  { name: "Balayage", price: 180, fromPrice: true, duration: 240, category: "Hair", description: "Natural hand-painted highlights." },
  { name: "Hair Cut", price: 35, duration: 45, category: "Hair", description: "Professional haircut tailored to you." },
  { name: "Keratin", price: 250, duration: 240, category: "Hair", description: "Smooth and straighten frizzy hair." },
  { name: "Highlight", price: 180, duration: 210, category: "Hair", description: "Lighter strands to add dimension." },
  { name: "Root Colour", price: 55, duration: 90, category: "Hair", description: "Touch up your hair roots." },
  { name: "Hair Color", price: 120, duration: 120, category: "Hair", description: "All-over color for a new look." },
