...
export default function HeroSection() {
  ...
  return (
    <section
      ...
      <div className="bg-black/10 backdrop-blur-sm px-4 py-6 sm:px-6 sm:py-8 font-display font md:px-10 rounded-2xl max-w-xl w-[90%] sm:w-auto text-center">
        <h2 className="text-2xl text-[#55203d] py-2 sm:text-3xl md:text-4xl text-white mb-3 sm:mb-4">
        ...
        <button
          ...
          className="bg-[#eabec5] text-[#55203d] font-bold px-6 py-2 rounded-full hover:bg-purplecolor hover:text-white transition"
        >
          BOOK NOW
        </button>
      </div>
