...
const IMAGES = Array.from({ length: 9 }, (_, i) => `/instagram/${i + 1}.jpg`);
    ...
    <section className="py-5">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div
          className={[
            "mt-8 sm:mt-10",
            "columns-2 lg:columns-3", // mobile=2, desktop=3
          ...
          {IMAGES.map((src) => (
            <a
              ...
              className={[
                ...
                "bg-white/30", // fallback while loading
            ...
            >
              ...
              {/* Darken overlay (hover + active + focus for mobile tap) */}
